...
const breadcrumbItems = [
    ...
    {
        name: 'PTE Đại Học',
        href: '/pte-dai-hoc', // Đường dẫn của trang hiện tại (mục cuối cùng)
    },
]
type ViewMode = 'grid' | 'list'
interface PTEuniversityListProps {
    data?: Article[]
}
const PTEuniversityList = ({
    data
}: PTEuniversityListProps) => {
...
export default PTEuniversityList
