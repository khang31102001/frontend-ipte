...
const ConsultationForm = ({
  ...
  return (
    <div className={`w-full section sm:section--sm lg:section--lg ${className}`}>
      <div className="container mx-auto px-4 rounded-3xl border border-slate-200 bg-slate-700  text-white shadow-sm">
        <div className="mx-auto w-full max-w-6xl section sm:section--sm lg:section--lg ">
