...
import { ABOUT_BASE } from '@/config/routes/routers'
...
const AboutSection = ({
    ...
    return (
        <>
            <section ref={containerRef} className="w-full section sm:section--sm lg:section--lg">
                    ...
                    <div className="mx-auto max-w-5xl px-4">
                        <div className="text-center">
                            {data.title && (
                                <h1 className="text-4xl md:text-5xl font-bold leading-tight text-center">
                                    <span className="relative  text-hero-gradient  inline-block pb-10">
                                        {data.title}{" "}
                        ...
                        <div className="w-full pt-2 flex justify-center mt-2">
                            <a
                                ...
                                bg-gradient-to-r from-brandBlue-900 to-brandBlue-500
